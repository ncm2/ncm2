...
# would be convinent for supporting language server protocol.  However, some
# language server doesn't support http protocol, for example,
...
# more difficult to implement the scoping feature. I'll stick to http protocol
# for now.
